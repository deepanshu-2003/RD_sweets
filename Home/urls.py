...
urlpatterns = [
    ...
    path('edit_customer/<str:user>',views.edit_customer,name="edit_customer"),
    path('block_customer/<str:user>',views.block_customer,name="block_customer"),
    path('unblock_customer/<str:user>',views.unblock_customer,name="unblock_customer"),
